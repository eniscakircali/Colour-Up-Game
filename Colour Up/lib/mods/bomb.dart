...
class bomb extends StatefulWidget {
  @override
  _bomb createState() => _bomb();
}

class _bomb extends State<bomb> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_start <= 0) {
      _bombscore() async{
        ...
        if((prefs.getInt("BombScore")) == null){
          prefs.setInt("BombScore", counter);
        }
        else if(counter > (prefs.getInt("BombScore"))){
          prefs.setInt("BombScore", counter);
        }
